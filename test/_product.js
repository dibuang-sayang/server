...
const dummyProduct = {
  ...
  stock: 10,
  picture:
    'https://s1.bukalapak.com/img/1755826719/large/Sandal_Jepit_Wanita___Sendal_Wedges_Panama___Chloe_Dark_Red.jpg',
};
    ...
    test('should succeed delete products', async () => {
      {
        ...
        expect(resDeleteProduct.data.deleteProduct).toEqual({
